...
class FinancialAI:
    def explain(self, description: str) -> str:
        ...
        completion = client.chat.completions.create(
            model="qwen-qwq-32b",  # Updated model name
            messages=messages,
            temperature=0.6,
            max_tokens=4096,
            top_p=0.95,
...
with tabs[0]:
    ...
    if st.button("Explain Option Prices", key="explain_bs"):
        ...
        """)
        st.markdown(f'<div class="highlight-box">{explanation}</div>', unsafe_allow_html=True)
...
st.markdown("""
    <div style="text-align: center; color: #666;">
        <p>Final Project for Data Science Degree – AI-enhanced Financial Analysis</p>
